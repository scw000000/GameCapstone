...
namespace SOT_replace {
	public class lib : MonoBehaviour {
		public static bool preserveOrientation = true;
		public static bool preserveScale = false;

		public static void replaceRenderGUI(int vpos, GameObject[] sceneSelection, GameObject projectActiveSelection)
		{
...
//						GameObject p = PrefabUtility.GetPrefabParent(projectActiveSelection) as GameObject;
//						if(p != null) {
...
//					}
					...
					SOT_lib.SHUX.alertBox ("Objects Replacement", "Select a prefab in the project window to enable this tool.");
				}
			} else {
				SOT_lib.SHUX.alertBox ("Objects Replacement", "Select objects in the hierarchy or in the scene view to enable this tool.");
